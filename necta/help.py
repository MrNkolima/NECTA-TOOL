...
def help():
  while True:
    ...
    print("""      █▄░█ █▀▀ █▀▀ ▀█▀ ▄▀█ ▄▄ ▀█▀ █▀█ █▀█ █░░
      █░▀█ ██▄ █▄▄ ░█░ █▀█ ░░ ░█░ █▄█ █▄█ █▄▄""")
    print(__BOLDPURPLE__+"                  "+"VERSION "+ __VERSION__+ __RESET__)
    print(__CYAN__+"          THIS TOOL CAN BE USED IN TWO WAYS:: "+__RESET__)
    print("\n")
    print(__BOLDRED__+"               F I R S T       WAY"+__RESET__)
    print("example:~$ "+__BOLDCYAN__+ "necta results"+__RESET__)
    print("This will lead you to see your results")
    print("")
    print(__BOLDRED__+"               S E C O N D    W A Y"+__RESET__)
    print(">>> "+__BOLDBLUE__+"necta {School Number} {Candidate Number} {Exam Year} {School Type}"+__RESET__)
    print("example:~$ "+__BOLDCYAN__+"necta s3140 0593 2018 csee"+__RESET__)
    print("")
    print(__BOLDRED__+"       OTHER COMMANDS    "+__RESET__)
    print("  necta version  - NECTA-TOOL version.")
    print("  necta update  - update NECTA-TOOL.")
    print("  necta uninstall - Uninstall NECTA-TOOL.")
    print("  necta help      - See This help.")
    print("")
    print(__BOLDRED__+"  DISCLAIMER ( TERMS OF USE )"+__RESET__)
    print(__YELLOW__+" [x] "+"Don't use this tool illegally by any means!!"+__RESET__)
    print("\n")
    print("Developer:::      "+__BLUE__+__DEVELOPER__+__RESET__)
    print("Visit my Twitter: "+__BLUE__+__TWITTER__+__RESET__)
    print("Visit my GitHub:  "+__BLUE__+__GITHUB__+__RESET__)
    print("\n")
    sys.exit()
